...
class MysqliDb
{
     ...
     */
    public function __construct($host = WHP_HOST, $username = null, $password = null, $db = null, $port = null, $charset = 'utf8')
    {
        $isSubQuery = false;
        ...
        $this->username =WHP_USER;
        $this->password = WHP_PASS;
        if (empty($db)) {
            $this->db = WHP_DB;
        } else {
            $this->db = $db;
    ...
    public function connect()
    {
        ...
        $this->_mysqli = new mysqli(WHP_HOST,WHP_USER, WHP_PASS, WHP_DB);
